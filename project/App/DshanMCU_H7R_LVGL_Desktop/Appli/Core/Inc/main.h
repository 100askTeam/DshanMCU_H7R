...
#define USER_KEY3_EXTI_IRQn EXTI2_IRQn
...
#define ENCODER_S1_Pin GPIO_PIN_5
#define ENCODER_S1_GPIO_Port GPIOP
#define ENCODER_S1_EXTI_IRQn EXTI5_IRQn
...
#define ENCODER_KEY_Pin GPIO_PIN_4
#define ENCODER_KEY_GPIO_Port GPIOP
#define ENCODER_S2_Pin GPIO_PIN_6
#define ENCODER_S2_GPIO_Port GPIOP
